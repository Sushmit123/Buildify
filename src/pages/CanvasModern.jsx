...
export default function Canvas() {
  ...
  const [columnsLayout, setColumnsLayout] = useState(1);
  ...
  const loadProject = (name) => {
    const data = localStorage.getItem(`buildify_project_${name}`);
    if (data) {
      const project = JSON.parse(data);
      setProjectName(project.name);
      setBlocks(project.blocks);
      setShapes(project.shapes);
      setCanvasBgColor(project.bgColor);
      setCanvasBgImage(project.bgImage);
      setActiveColor(project.primaryColor);
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <div className="flex-1 flex flex-col mt-16 overflow-auto">
        <div
          ref={canvasRef}
          className="flex-1 p-6 mx-auto w-full overflow-auto"
          style={{
        ...
        >
          <div
            className="mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-2xl"
            style={{
            ...
            {blocks.map((b, index) => {
              ...
              return (
                <div
                  ...
                  className={`mb-4 p-3 rounded border-2 transition ${
